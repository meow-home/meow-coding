...
|---|---|
| `TitleBar.tsx` | Custom window chrome for frameless platforms; `.title-bar-brand` seamlessly matches the sidebar's width (`22.333rem` expanded / `4.333rem` collapsed), background color, and right border. |
