...
const api: AgentApi = {
  ...
  reorderWorkspaces: (projectPaths: string[]) =>
    ipcRenderer.invoke(Channels.WorkspaceReorder, projectPaths),
  ...
  runCommand: (agentId: string, name: string, args: string, images?: ImageAttachment[]) =>
